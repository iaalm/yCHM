...
"""
    ...
    func testNormal() throws {
        let data = testHtml.data(using: .utf8)!
        let res = parseIndex(data)
        assertIndexIsRight(res)
    }
    
    func testNoSlashLI() throws {
        let data = testHtml.replacingOccurrences(of: "</LI>", with: "").data(using: .utf8)!
        let res = parseIndex(data)
        assertIndexIsRight(res)
    }
    ...
    func testGB18030() throws {
        ...
        let data = testHtml.replacingOccurrences(of: "specialitem", with: st).data(using: gb_18030_2000)!
        let res = parseIndex(data)
